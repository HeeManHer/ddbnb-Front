...
const KAKAO_REDIRECT_URI = `https://www.ddbnb.site/kakao/callback`;
...
const NAVER_REDIRECT_URI = encodeURI(`https://www.ddbnb.site/login/oauth2/code/naver`);
...
// const GOOGLE_REDIRECT_URI = encodeURI(`https://www.ddbnb.site/login/oauth2/code/google`);
