...
const KAKAO_REDIRECT_URI = `http://www.ddbnb.site/kakao/callback`;
...
const NAVER_REDIRECT_URI = encodeURI(`http://www.ddbnb.site/login/oauth2/code/naver`);
...
// const GOOGLE_REDIRECT_URI = encodeURI(`http://www.ddbnb.site/login/oauth2/code/google`);
