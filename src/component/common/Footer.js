...
function Footer() {
    return (
        <footer className="back-color ">
            <footer className="main-width dis-flex aling-center">
                <img src="/img/logo-white.png" alt="댕댕비엔비" height="100%" />
                <div className="footer dis-flex ">
                    <div className="navbar dis-flex aling-center">
                        <span>약관</span>
                    ...
                    <div className="footerInfo dis-flex aling-center">
                        <div className="info dis-flex aling-center">
